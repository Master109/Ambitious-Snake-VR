...
namespace UnityEngine.EventSystems
{
    public class OVRInputModule : PointerInputModule
    {
	    ...
	    // public AmbitiousSnake.InputManager.VRButtonGroup clickVrButtonGroup;
...
#region PointerEventData pool
        ...
        protected MouseState GetGazePointerData()
        {
	        ...
	        leftData.worldSpaceRay = new Ray(VRCameraRig.CurrentHand.position, VRCameraRig.CurrentHand.forward);
            ...
            if (ovrRaycaster) 
            {
                ...
                if (graphicRect != null)
                {
	                ...
	                VR_UIPointer.instance.SetPosition(worldPos, normal);
                    // Make sure it's being shown
                    VR_UIPointer.instance.RequestShow();
                }
            }
            ...
            if (physicsRaycaster)
            {
                ...
                VR_UIPointer.instance.RequestShow();
                VR_UIPointer.instance.SetPosition(raycast.worldPosition, raycast.worldNormal);
            }
